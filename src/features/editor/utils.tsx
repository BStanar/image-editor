...
export const createFilter = (value: string) => {
  ...
  switch (value) {
    case "greyscale":
      ...
      break;
    case "polaroid":
      // @ts-expect-error Polaroid exists
    ...
    case "sepia":
      ...
      break;
    case "kodachrome":
      // @ts-expect-error Kodachrome exists
    ...
    case "brightness":
      ...
      break;
    case "brownie":
      // @ts-expect-error Brownie exists
      effect = new fabric.Image.filters.Brownie();
      break;
    case "vintage":
      // @ts-expect-error Vintage exists
      effect = new fabric.Image.filters.Vintage();
      break;
    case "technicolor":
      // @ts-expect-error Technicolor exists
    ...
    case "emboss":
      ...
      break;
    case "removecolor":
      // @ts-expect-error RemoveColor exists
      ...
      break;
    case "blacknwhite":
      // @ts-expect-error BlackWhite exists
      effect = new fabric.Image.filters.BlackWhite();
      break;
    case "vibrance":
      // @ts-expect-error Vibrance exists
